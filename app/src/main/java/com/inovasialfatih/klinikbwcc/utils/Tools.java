package com.inovasialfatih.klinikbwcc.utils;
...
import com.inovasialfatih.klinikbwcc.data.ActivityWebView;
...
//    }
    ...
    public static void displayImageOriginal(Context ctx, ImageView img, ImageSlider.ImageSliderData url) {
        try {
